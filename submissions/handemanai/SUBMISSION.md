...
that, I tried to stay out of the agents' way and let them work. They did all of
the implementation, testing, analysis, and drafting. `MEMO.md` explains the
system, its remaining failure boundary, and what I would do with another week.
